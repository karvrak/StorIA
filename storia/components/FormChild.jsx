...
return (
    <form onSubmit={handleSubmit} className="max-w-xl mx-auto p-8">
      ...
      <div className="mb-5">
        ...
        <button type="button" onClick={handleReset} className="px-4 py-2 text-white bg-red-500 rounded-md hover:bg-red-600 focus:outline-none">Clear</button>
